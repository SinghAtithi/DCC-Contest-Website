...
const ViewRegistrations = ()=>{
    ...
    useEffect(()=>{
        ...
        if(loggedIn && (role===ADMIN || role === SUPER_ADMIN)) toggleLoaderBackdrop();
            ...
            checkToken().then((status)=>{
                ...
                else Router.push(LOGIN_PAGE+"?next=admin/contest/registrations");
            })
        }
    },[])
    ...
    return (
        <>
            <SideNav role={role} highlight={AdminSideNavMap.view_registrations}/>
            <div className="data-area">
                Hello from View Registrations Page
            </div>
        </>
    )
}
