...
<<<<<<< Updated upstream
    ...
    useEffect(() => {
        ...
        if (contestID.indexOf(" ") >= 0)
            setContestIDError("Contest ID cannot contain space.");
    ...
    useEffect(() => {
        if (startTime != "" && !validateDateTimeString(startTime)) {
            setStartTimeError(
                "Please enter the date and time as per the format"
            );
    ...
    const reinitialiseContestState = () => {
        ...
        setQuesIDs(
            quesIDs.filter((id) => {
                const notToBeIncluded = new Set(ques_ids);
                if (!notToBeIncluded.has(id)) return id;
            })
        );
    ...
    return (
        <div>
            ...
            <SideNav
                role="SuperAdmin"
                highlight={AdminSideNavMap.create_contest}
            />
                ...
                <div className="contest_container">
                    <div className="contest_details_area">
                        ...
                        <div className="flex w-full items-center justify-center">
                            ...
                            !timeError ? (
                                <button
                                    className="btn btn-outline btn-success mt-2 mx-2 mb-2"
                                    onClick={onSubmit}
                                >
                                    Submit
                                </button>
                                ...
                                <button
                                    className="btn btn-outline btn-error mt-2 mx-2 mb-2 btn-disabled"
                    ...
                    <div className="tooltip tooltip-warning" data-tip="Add">
                      <div
                        ...
                        onClick={() => {
                          ...
                          setSearchedList(
                            searchedList.filter((_, i) => i !== index)
                          );
                        }}
                      >
                        <span className="font-mono font-bold px-3">
                  ...
                  {ques_ids.map((value, index) => (
                    <div className="tooltip tooltip-error" data-tip="Remove">
                      <div
                        ...
                        onClick={() => {
                          if (searchString)
                            setSearchedList([...searchedList, ques_ids[index]]);
