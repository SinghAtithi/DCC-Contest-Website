...
const ViewResults = () => {
    ...
    useEffect(() => {
        ...
        if (loggedIn && (role === ADMIN || role === SUPER_ADMIN))
            ...
            checkToken().then((status) => {
                ...
                } else Router.push(LOGIN_PAGE + "?next=admin/contest/results");
            });
        }
    }, []);
    ...
    return (
        <>
            <SideNav role={role} highlight={AdminSideNavMap.view_results} />
            <div className="data-area">Hello from View Results Page</div>
        </>
    );
};
