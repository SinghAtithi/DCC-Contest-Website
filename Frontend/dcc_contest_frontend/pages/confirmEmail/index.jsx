...
import { BASE_URL,LOGIN_PAGE, RESEND_CONFIRMATION_EMAIL, SEND_FORGOT_PASSWORD_EMAIL_BACKEND, SIGNUP_PAGE } from "../../utils/constants";
...
function ResendConfirmationEmail() {
  ...
  const onSubmit = () => {
    ...
    const URL = BASE_URL + RESEND_CONFIRMATION_EMAIL;
    axios
    ...
    <div>
      ...
      <div className="container min-w-full mt-16 w-full flex justify-around items-center">
        <div className="login flex items-start w-3/12 flex-col">
          ...
          <Link href={LOGIN_PAGE} className="py-4" onClick={()=>{
            toggleLoaderBackdrop();
          }}>Login</Link>
